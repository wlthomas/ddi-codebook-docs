...
htmlhelp_basename = 'DDI-Codebook (2.6) High Level Documentation'
...
latex_documents = [
  ('index', 'DDI.tex', u'DDI-Codebook (2.6) High Level Documentation',
   u'DDI', 'manual'),
]
...
epub_title = u'DDI-Codebook (2.6) High Level Documentation'
epub_author = u'DDI Alliance'
epub_publisher = u'DDI Alliance'
epub_copyright = u'2025 DDI Alliance'
