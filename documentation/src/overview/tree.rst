...
- Heavily repeated (GLOBAL) attributes have not been included in the tree description
...
- See High Level documentation for details on sets of string and concept types and their specific attributes (Text Types and Controlled Vocabuary)


``0            codeBook (1-1) [version, codeBookAgency, access]
1               docDscr (0-n) [access]
...
1.1.2                 rspStmt (0-1)
1.1.2.1                  AuthEnty (0-n) [affiliation, abbr, agentIdentifier, typeOfAgentIdentifier, isPersistentIdentifier, agentType]
1.1.2.2                  othId (0-n) [type, role, abbr, affiliation, agentIdentifier, typeOfAgentIdentifier, isPersistentIdentifier, agentType]
1.1.3                 prodStmt (0-1)
1.1.3.1                  language (0-n) [typeOfLanguageCode, languageCode]
1.1.3.2                  producer (0-n) [abbr, affiliation, role, agentIdentifier, typeOfAgentIdentifier, isPersistentIdentifier, agentType]
...
1.1.3.8                  fundAg (0-n) [abbr, affiliation, role, agentIdentifier, typeOfAgentIdentifier, isPersistentIdentifier, agentType]
1.1.3.9                  grantNo (0-n) [agency, fundingProgram, URI, grantName, role]
1.1.4                 distStmt (0-1)
1.1.4.1                  distrbtr (0-n) [abbr, affiliation, URI, agentIdentifier, typeOfAgentIdentifier, isPersistentIdentifier, agentType]
1.1.4.2                  contact (0-n) [affiliation, URI, email, agentIdentifier, typeOfAgentIdentifier, isPersistentIdentifier, agentType]
1.1.4.3                  depositr (0-n) [abbr, affiliation, agentIdentifier, typeOfAgentIdentifier, isPersistentIdentifier, agentType]
1.1.4.4                  depDate (0-n)
...
1.1.6.2                  verResp (0-n) [affiliation, agentIdentifier, typeOfAgentIdentifier, isPersistentIdentifier, agentType]
...
1.2                guide (0-n)
1.3                docStatus (0-n) [vocab, vocabURI, vocabInstanceURI, vocabID, vocabAgencyName, vocabVersionID, otherValue, vocabSchemeURN, vocabInstanceCodeTerm]
...
2.2.1                 authorizingAgency (0-n) [abbr, affiliation, agentIdentifier, typeOfAgentIdentifier, isPersistentIdentifier, agentType]
...
2.3.4.7.1.1                    point (1-n)
2.3.4.7.1.1.1                     gringLat (1-1)
2.3.4.7.1.1.2                     gringLon (1-1)
...
2.3.5.1.1.1                    standardName (0-n) [date, version, URI]
2.3.5.1.1.2                    producer (0-n) [abbr, affiliation, role, agentIdentifier, typeOfAgentIdentifier, isPersistentIdentifier, agentType]
2.3.5.1.2                   complianceDescription (0-n)
...
2.3.7.2                  evaluator (0-n) [abbr, affiliation, role, agentIdentifier, typeOfAgentIdentifier, isPersistentIdentifier, agentType]
...
2.4.1.3                  participant (0-n) [abbr, affiliation, role, agentIdentifier, typeOfAgentIdentifier, isPersistentIdentifier, agentType]
...
2.5.1.2                  dataCollector (0-n) [abbr, affiliation, role, agentIdentifier, typeOfAgentIdentifier, isPersistentIdentifier, agentType]
...
2.5.1.6.5                   custodian (0-n) [abbr, affiliation, role, agentIdentifier, typeOfAgentIdentifier, isPersistentIdentifier, agentType]
2.5.1.6.6                   useStmt (0-n)
2.5.1.6.6.1                    confDec (0-n) [required, formNo, URI]
2.5.1.6.6.2                    specPerm (0-n) [required, formNo, URI]
2.5.1.6.6.3                    restrctn (0-n)
2.5.1.6.6.4                    contact (0-n) [affiliation, URI, email, agentIdentifier, typeOfAgentIdentifier, isPersistentIdentifier, agentType]
2.5.1.6.6.5                    citReq (0-n)
2.5.1.6.6.6                    deposReq (0-n)
2.5.1.6.6.7                    conditions (0-n)
2.5.1.6.6.8                    disclaimer (0-n)
...
2.6.2.3                  origArch (0-n) [abbr, URI, affiliation, agentIdentifier, typeOfAgentIdentifier, isPersistentIdentifier, agentType]
...
2.7.3.2                  specPerm (0-n) [required, formNo, URI]
2.7.3.3                  restrctn (0-n)
2.7.3.4                  contact (0-n) [affiliation, URI, email, agentIdentifier, typeOfAgentIdentifier, isPersistentIdentifier, agentType]
2.7.3.5                  citReq (0-n)
...
3.1.14.2                 verResp (0-n) [affiliation, agentIdentifier, typeOfAgentIdentifier, isPersistentIdentifier, agentType]
...
4.2                nCubeGrp (0-n) [type, otherType, nCube, nCubeGrp, name, sdatrefs, methrefs, pubrefs, access]
...
4.3                var (0-n) [name, wgt, wgt-var, weight, qstn, files, vendor, dcml, intrvl, rectype, sdatrefs, methrefs, pubrefs, access, aggrMeth, otherAggrMeth, measUnit, scale, origin, nature, othernature, additivity, otherAdditivity, temporal, geog, geoVocab, catQnty, representationType, otherRepresentationType]
...
4.3.20.2                 verResp (0-n) [affiliation, agentIdentifier, typeOfAgentIdentifier, isPersistentIdentifier, agentType]
...
4.4.10.2                 verResp (0-n) [affiliation, agentIdentifier, typeOfAgentIdentifier, isPersistentIdentifier, agentType]
